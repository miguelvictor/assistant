  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content bg-muted text-foreground px-4 py-2.5 text-sm leading-5 tracking-tighter wrap-break-word">
          <MessagePrimitive.Parts />
        </div>
